    ...
    return(
        ...
        <section className="content_info padding-bottom-50 padding-top-50">
            <div className="paddings">
                <div className="container" >
                    <div className="row" id="Ecommerce#Magento_development">

                        <div className="col-md-12" id="Ecommerce#Magento_development">
                    ...
                    <div className="row" id="Ecommerce#nop_development">
                        <div className="col-sm-7" id="Ecommerce#Prestashop">
                            <ul>
