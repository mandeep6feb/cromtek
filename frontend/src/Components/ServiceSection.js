        ...
        <section className="content_info padding-bottom-50 padding-top-50">
            <div className="paddings">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <div id="web_img" className="content-img" ><img src="images/services_lang.jpeg" alt="Web Application Development" /></div>
                        </div>
                    </div>

                    <div className="row">
                        <div className="col-md-4">
                            <div id="mobile_img" className="content-img"><img src="images/page_mobile_app.png" alt="Mobile Application Development" /></div>
                        </div>
                        <div className="col-md-8">
                            <div id="mobile_cont">
                    ...
                    <div className="col-md-4">
                        <div id="application_img" className="content-img"><img src="images/erp.png" alt="Custom ERP Solution Developments" /></div>
                    </div>
                </div>

                <div className="row">
                    <div className="col-md-4">
                        <div className="content-img"><img src="images/enterprise_final_img.svg" alt="Enterprise Solution Implementations" /></div>
                    </div>
                    <div className="col-md-8">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="content-img"><img src="images/app2_maintain_img.svg" alt="Application Maintenance and Support" /></div>
                    </div>
                </div>
