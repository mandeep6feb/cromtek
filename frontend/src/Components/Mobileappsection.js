                        ...
                        <div className="col-md-9">
                            ...
                            <div className="row">
                                <div className="col-md-3">
                                    <div className="about-know"><img src="../images/page_mobile_app.png" alt="mobile application development" /></div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-3">
                                    <div className="about-know"><a href="http://www.upark.in"><img src="../images/Smart-parking.png" alt="mobile app development company in india " /></a></div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-3">
                                    <div className="about-know"> <a href=""><img src="../images/Online-eBook-store.jpeg" alt="Collaborative Platform for Book Stores and Readers " /></a></div>
                                </div>
                                <div className="colo-md-9">
                            ...
                            <div className="row">
                                <div className="col-md-3">
                                    <div className="about-know"> <a href="https://play.google.com/store/apps/details?id=com.logtaxiparis"> <img src="../images/TaxiApp1.png" alt="mobile application development company" /></a></div>
                                </div>
                                <div className="colo-md-9">
